...
@Entity(tableName = ConstantsResources.TABLE_ALL_PRODUCT)
...
public Products(@NonNull Integer productId, Integer productCategoryId,
                ...
                String productSpecificationBd, Integer productQuantity,
                String productPrice, String productOfferPrice,
                Integer productStatus, Integer productFeatured,
                Integer productWeekDeals, Integer productOnsale,
                Integer productToprated, String productSku, String productSlug,
                String productAttributeSetId, String productAttributesId,
                String productImage, String productAttributeOptions)
{
